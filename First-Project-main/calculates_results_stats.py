...
# DATE CREATED: START 16/04/2024 AT 10:PM KSA TIME
...
def calculates_results_stats(results_dic):
    ...
    # Create results_stats_dic using Counter
    results_stats_dic = Counter({
        'n_images': n_images,
    ...
    # I founded best way to implement counter from collections and calcualte it directly,
    # I saw in other students solved it by another way but I preferred to be special
